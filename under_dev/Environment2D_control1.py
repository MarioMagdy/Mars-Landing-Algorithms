...
def draw_environment(screen):
    ...
    mars_texture = pygame.image.load(r'D:\Control_Codes\mars_texture.png').convert_alpha()
    mars_background = pygame.image.load(r'D:\Control_Codes\mars_background.png').convert_alpha()
